...
import { buildStep1aEvalPrompt } from './prompts/v3-step1a-eval-prompt'
  ...
  if (garmentCollageReference) {
    ...
    evalImages.push({
      ...
      description:
        ...
        'GARMENT COLLAGE REFERENCE - Source of truth for authorized wardrobe structure, colors, and accessories for this outfit.',
    })
  }
