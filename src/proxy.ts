...
function addSecurityHeaders(response: NextResponse) {
  ...
  const csp = [
    ...
    `connect-src 'self' https://api.resend.com https://cloudflareinsights.com https://pineapple.teamshotspro.com https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://region1.analytics.google.com https://www.googletagmanager.com https://storage.googleapis.com https://cdn.jsdelivr.net https://unpkg.com https://tfhub.dev https://www.kaggle.com https://*.apollo.io ${posthogDomains} ws: wss:`,
