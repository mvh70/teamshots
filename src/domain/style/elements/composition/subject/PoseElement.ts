...
export class PoseElement extends StyleElement {
  ...
  async contribute(context: ElementContext): Promise<ElementContribution> {
    ...
    // Build payload structure from generated pose result
    ...
    // Add general pose rules (quality constraints not in JSON)
    mustFollow.push(
  ...
  /**
   * Get quality rules for pose templates
   * Returns mood/feeling constraints, not technical specifications (those are in JSON payload)
   */
