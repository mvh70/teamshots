...
// - portreya.json: Portreya domain-specific landing content
...
type PortreyaMessages = typeof import('../../messages/en/individualshots.json')

// Merge all possible messages for maximum type coverage and autocomplete
type Messages = SharedMessages & TeamShotsMessages & PortreyaMessages
