...
#### 12. Generation Detail Tour (`generation-detail`)
...
4. User creates first generation with own selfies
      - If free plan: `free plan photo style`
      - If paid plan: `freestyle photo style
...
2. User creates team (teamId assigned)
3. Team admin welcome tour (`team-admin-welcome`) triggers
   - Welcome message
...
3. Bring the user as quickly as possible to first generation
